...
from graph.training import supervised_training_multiple_with_test_all_vertices, unsupervised_training_multiple
from graph.gcn import GIN
from graph.load_data import supervised_data_loader_with_test_all_vertices, unsupervised_dataLoader
...
loader_supervised = supervised_data_loader_with_test_all_vertices(
...
supervised_training_multiple_with_test_all_vertices(
    epochs=1,
